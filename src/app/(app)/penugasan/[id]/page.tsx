...
export default async function DetailPenugasanPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (error || !assignment) {
    return (
      <main className="mx-auto max-w-2xl">
        ...
        <Link href="/penugasan" className="mt-4 inline-block text-sm text-slate-500 hover:underline">
  ...
  return (
    <main className="mx-auto max-w-3xl space-y-6">
      <Link href="/penugasan" className="text-sm text-slate-500 hover:underline">
        &larr; Kembali ke daftar penugasan
      </Link>
